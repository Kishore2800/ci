...
<div class="col-sm-3">
<input type="text" name="apticant3" class="form-control" >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="inter_name3" class="form-control" >
</div>
</div>             
...
<div class="mb-3 row">
     ...
     <div class="col-sm-8">
      <input type="text" name="inter_desig3" class="form-control" >
    </div>
</div>
...
<div class="mb-3 row">
     ...
     <div class="col-sm-8">
      <input type="Date" name="inter_date3" class="form-control" >
    </div>
    </div>
...
<div class="mb-3 row">
   <div class="col-sm-4">
     ...
     <div class="col-sm-8">
     <select name="inter_location3" class="form-control" >
   ...
   <div class="col-sm-4">
     ...
     <div class="col-sm-8">
     <select name="recommendation3" class="form-control" >
	...
	<div class="mb-3 row">
     ...
     <div class="col-sm-8">
	 <textarea type="text"  name="inter_note3" class="form-control" ></textarea>
    </div>
 </div>
