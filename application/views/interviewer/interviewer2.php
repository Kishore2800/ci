...
<div class="col-sm-3">
<input type="text" name="apticant2" class="form-control" >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="inter_name2" class="form-control" >
</div>
</div>
<div class="mb-3 row">
              <div class="col-sm-4">
   ...
   <div class="col-sm-8">
    <input type="text" name="inter_desig2" class="form-control" >
  </div>
</div>
<div class="mb-3 row">
     <div class="col-sm-4">
   ...
   <div class="col-sm-8">
    <input type="Date" name="inter_date2" class="form-control" >
  </div>
</div>
<div class="mb-3 row">
 <div class="col-sm-4">
   ...
   <div class="col-sm-8">
   <select name="inter_location2" class="form-control" >
 ...
 <div class="col-sm-4">
   ...
   <div class="col-sm-8">
   <select name="recommendation2" class="form-control" >
