...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <h1><b>User</b>Login</a></h1>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Sign in to start your session</p>
      <div><?echo validation_errors()?></div>
      <form action="<?php echo base_url('User/login_user')?>" method="POST">
      ...
      <!-- /.social-auth-links -->
      <p class="mb-1">
        <a href="<?=base_url();?>user/signup" class="text-center">Register here</a>
      </p>
      <p class="mb-2">
      <a href="<?=base_url('user/forgot_password');?>" class="text-center"type="forgot_password" value="forgot_password">  forgot my password</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
